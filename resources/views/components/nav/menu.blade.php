...
<div class="navigation-menu-body">
    ...
    <div>
        <div id="navigation-logo">
            <a href="{{ route('index') }}">
                <img class="logo" src="{{ asset('assets/media/image/logo.png') }}" alt="image" style="filter: invert(1);width: 150px;">
                <img class="logo-dark" src="{{ asset('assets/media/image/logo-dark.png') }}" alt="image">
            </a>
        </div>
    </div>
    <!-- end::navigation-logo -->
